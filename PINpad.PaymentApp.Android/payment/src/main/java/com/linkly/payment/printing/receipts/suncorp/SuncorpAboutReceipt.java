...
public class SuncorpAboutReceipt extends Receipt {
    ...
    public PrintReceipt generateReceipt(Object obj) {
        ...
        receipt.getLines().add(new PrintReceipt.PrintTableLine(getText(STR_PTID)+": ", SN, SMALL_FONT));
        receipt.getLines().add(new PrintReceipt.PrintTableLine(getText(STR_TERMINAL_SN), SN, SMALL_FONT));
        receipt.getLines().add(new PrintReceipt.PrintTableLine(getText(STR_MODEL), EFTPlatform.getModel(), SMALL_FONT));
