...
public class Iso8583Rev93 extends Iso8583 implements IMessage {
    ...
    static {
        ...
        try {
            ...
            defaultTemplate.put(Bit._022_POS_DATA_CODE, FieldDescriptor.getAsciiFixed(12, FieldValidators.getAns()));
    ...
    public static class MsgType {
         ...
         * DCC Request
         */
        public static final int _1305_DCC_ENQUIRY_REQ = 0x1305;
    ...
    public static final class PosDataCode {
        ...
        public String toString() {
            String result = cardDataInputCapability + cardholderAuthCapability + cardCaptureCapability + operatingEnvironment
            ...
            if (!Util.isNullOrWhitespace(terminalOperator))
                result += terminalOperator;

            if (!Util.isNullOrWhitespace(terminalType))
                result += terminalType;
    ...
    public class Bit {
         ...
         */
        public static final int _006_BILLING_AMOUNT = 6;
         ...
         * Conversion rate (dcc)
         */
        public static final int _010_CONVERSION_RATE = 10;
        ...
        /**
         * Field 23 - P2PCard Sequence Number
         */
        ...
        /**
         * Field 42 - P2PCard Acceptor ID
         */
        public static final int _042_CARD_ACCEPTOR_ID = 42;

        /**
         * Field 43 - Payment Facilitator
         */
        public static final int _043_PAYMENT_FACILITATOR = 43;
        ...
        /**
         * Field 51 - Cardholder Billing Currency
         */
        public static final int _051_CARDHOLDER_BILLING_CURRENCY_CODE = 51;
         ...
         */
        public static final int _060_ELAVON_PRIVATE_DATA = 60;
        public static final int _063_ELAVON_PRIVATE_DATA_3 = 63;
    ...
    public class FuncCode {
        ...
        public static final String _500_RECONCILIATION = "500";
        public static final String _504_RECONCILIATION_ADVICE = "504";
