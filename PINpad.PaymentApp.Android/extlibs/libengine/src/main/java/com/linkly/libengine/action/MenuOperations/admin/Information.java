...
import static com.linkly.libengine.printing.IPrintManager.ReportType.ABOUTAPP_REPORT;
...
public class Information extends IAction {
    ...
    public void run() {
        ...
        IReceipt receipt = d.getPrintManager().getReceiptForReport(d, ABOUTAPP_REPORT, mal);
