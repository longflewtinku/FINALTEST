...
import com.linkly.libengine.action.check.CheckSubTotals;
...
public class AutoSubTotals extends Workflow {
    public AutoSubTotals() {
        ...
        this.addAction(new CheckSubTotals());
