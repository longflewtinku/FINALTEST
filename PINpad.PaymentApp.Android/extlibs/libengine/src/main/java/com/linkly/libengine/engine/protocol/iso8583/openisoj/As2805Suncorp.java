...
import static com.linkly.libengine.engine.protocol.iso8583.openisoj.As2805Suncorp.Bit._063_ADDITIONAL_PRIVATE;
...
public class As2805Suncorp extends Iso8583 implements IMessage {
    public class Bit {
    ...
    static {
        try {
            ...
            template.put(_002_PAN, FieldDescriptor.getBcdVar(2,19));
            ...
            template.put(_014_EXPIRATION_DATE, FieldDescriptor.getBcdFixed(4));
            ...
            template.put(_032_ACQUIRING_INST_ID_CODE, FieldDescriptor.getBcdVar(2,11));
            template.put(_035_TRACK_2_DATA, FieldDescriptor.getBcdVar(2,38));
            ...
            template.put(_039_RESPONSE_CODE, FieldDescriptor.getAsciiFixed(2, FieldValidators.getAn()));
            ...
            template.put(_043_CARD_ACCEPTOR_NAME_LOCATION, FieldDescriptor.getAsciiVar(2, 99, FieldValidators.getAns()));
            template.put(_044_ADDITIONAL_RESPONSE_DATA,FieldDescriptor.getAsciiVar(2, 99, FieldValidators.getAns()));
            template.put(_047_ADDITIONAL_DATA_NATIONAL, FieldDescriptor.getAsciiVar(3, 999, FieldValidators.getAns()));
            ...
            template.put(_060_ADDITIONAL_PRIVATE, FieldDescriptor.getAsciiVar(3, 999, FieldValidators.getAns()));
            template.put(_061_ADDITIONAL_PRIVATE, FieldDescriptor.getAsciiVar(3, 999, FieldValidators.getAns()));
            template.put(_062_ADDITIONAL_PRIVATE, FieldDescriptor.getAsciiVar(3, 999, FieldValidators.getAns()));
            template.put(_063_ADDITIONAL_PRIVATE, FieldDescriptor.getAsciiVar(3, 999, FieldValidators.getAns()));
    ...
    public As2805Suncorp(byte[] data) throws Exception {
        this();
        unpack(data, 0);
    }
    ...
    public class MsgType extends Iso8583.MsgType {
        public static final int _0820_NWRK_MGMT_KEY_CHANGE_ADVICE = 0x820;
        public static final int _0830_NWRK_MGMT_KEY_CHANGE_RESPONSE = 0x830;
        public static final int _9820_PRIVATE_NETWORK_MSG_REQUEST = 0x9820;
        public static final int _9830_PRIVATE_NETWORK_MSG_RESPONSE = 0x9830;
    }
}
