...
public final class ActionCodeRspCodeMap {
    ...
    protected static void populateRspCodeMap() {
        ...
        rspCodeMap.put("125", "30");
        rspCodeMap.put("126", "55");
        ...
        /* special cases for iso8583  and svfe rec */
        rspCodeMap.put("500", "500");
        rspCodeMap.put("501", "501");
        rspCodeMap.put("502", "502");
        rspCodeMap.put("503", "503");
        rspCodeMap.put("901", "30");
        ...
        rspCodeMap.put("910", "30");
        rspCodeMap.put("911", "68");
        rspCodeMap.put("912", "30");
        rspCodeMap.put("913", "94");
        rspCodeMap.put("914", "25");
        rspCodeMap.put("915", "95");
        rspCodeMap.put("920", "55");
        rspCodeMap.put("921", "21");
        rspCodeMap.put("923", "09");
        rspCodeMap.put("940", "35");
        rspCodeMap.put("941", "05");
    }
    ...
    protected static void populateActionCodeMap() {
        ...
        /* special cases for iso8583 rec */
        actionCodeMap.put("500", "500");
        actionCodeMap.put("501", "501");
        actionCodeMap.put("502", "502");
        actionCodeMap.put("503", "503");
    }
}
