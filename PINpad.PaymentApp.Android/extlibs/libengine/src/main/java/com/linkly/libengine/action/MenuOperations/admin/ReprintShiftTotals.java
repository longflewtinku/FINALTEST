...
import static com.linkly.libengine.printing.IPrintManager.ReportType.REPRINT_SHIFT_TOTALS_REPORT;
...
public class ReprintShiftTotals extends IAction {

    @Override
    public String getName() {
        return "ReprintShiftTotals";
    }

    @Override
    public void run() {
        ui.showScreen(PROCESSING_PLEASE_WAIT_SHORT);
        IReceipt receipt = d.getPrintManager().getReceiptForReport(d, REPRINT_SHIFT_TOTALS_REPORT, mal);
