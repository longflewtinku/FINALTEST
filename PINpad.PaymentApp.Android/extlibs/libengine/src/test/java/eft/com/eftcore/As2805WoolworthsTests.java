 ...
 */
public class As2805WoolworthsTests {
    private static final String TAG = "As2805WoolworthsTests";
...
//            //msg.set(_055_ICC_DATA, "" );
...
//    }
    ...
    public void test0210FuelCardUnpack() {
        ...
        try {
            final byte[] inputData = {
                    ...
                    0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x09,0x00,0x02,
                    0x22,0x62,0x01,0x57,0x40,0x10,0x01,0x10,0x01,0x31,
                    0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x30,0x30,0x46,
                    0x32,0x37,0x37,0x33,0x30,0x35,0x31,0x36,0x31,0x31,
                    0x30,0x30,0x30,0x36,0x30,0x32,0x30,0x30,0x32,0x37,
                    0x37,0x33,0x30,0x32,0x34,0x54,0x4f,0x4b,0x37,0x30,
                    0x37,0x31,0x33,0x34,0x38,0x30,0x30,0x36,0x33,0x33,
                    0x30,0x32,0x39,0x36,0x31,0x39,0x39,0x39,0x5c,0x00,
                    0x36,(byte)0xf9,0x4e,0x08,0x00,0x00,0x00,0x00,0x00 };
            As2805Woolworths msg = new As2805Woolworths(inputData);
            ...
            assertEquals( "TOK70713480063302961999\\", msg.get(_047_ADDITIONAL_DATA_NATIONAL));
            ...
            assertEquals( "F94E080000000000", msg.get(_064_MAC));
    ...
    public void test0200PurchaseByInsertPack() {
        try {
            ...
            msg.set(_047_ADDITIONAL_DATA_NATIONAL, "TCC07\\" );
            msg.set(_049_TRAN_CURRENCY_CODE, "036" );
            msg.set(_052_PIN_DATA, "2A2A2A2A2A2A2A2A" );
            //msg.set(_054_ADDITIONAL_AMOUNTS, "109127319203" );
            msg.set(_055_ICC_DATA, "" );
            msg.set(_057_CASH_AMOUNT, "000000020000");
            msg.set(_060_ADDITIONAL_PRIVATE, "0");
            msg.set(_064_MAC, "59B4655A00000000");

            byte[] actual = msg.toMsg();
            byte[] expected = { 0x02,0x00,0x30,0x20,0x06,(byte)0x81,0x28,(byte)0xc2,(byte)0x92,(byte)0x91,0x09,0x20,0x00,0x00,0x00,0x00,
                                0x02,0x15,(byte)0x98,0x07,0x48,(byte)0x90,0x00,0x51,0x00,0x01,0x04,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,
                                0x33,0x37,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x02,(byte)0xD2,0x01,0x20,0x12,(byte)0x98,0x31,0x20,(byte)0x93,(byte)0x88,0x12,0x3F,
                                ...
                                0x37,0x5c,0x00,0x36,0x2a,0x2a,0x2a,0x2a,0x2a,0x2a,0x2a,0x2a,0x31,0x34,0x33,0x5f,0x2a,0x02,0x00,0x36,(byte)0x82,
    ...
    public void test0200PurchaseByTapPack() {
        try {
            ...
            msg.set(_052_PIN_DATA, "2A2A2A2A2A2A2A2A" );
            //msg.set(_054_ADDITIONAL_AMOUNTS, "109127319203" );
            msg.set(_055_ICC_DATA, "5f2a02003682020000950500000000009a031610019c01009f02060000000020009f03060000000000009f100706011103a000009f1a0200369f2608ea9308c1bbc97fab9f2701809f33030060409f34031f00009f3501229f360207939f3704065747bd9f6e04207000008407a00000000310109f660436804000" );
            msg.set(_057_CASH_AMOUNT, "000000000000");
            msg.set(_060_ADDITIONAL_PRIVATE, "0");
            msg.set(_064_MAC, "3C89DA9E00000000");

            byte[] actual = msg.toMsg();
            byte[] expected = {
                    0x02,0x00,0x30,0x20,0x06,(byte)0x81,0x28,(byte)0xc2,(byte)0x92,(byte)0x91,
                    0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x20,0x00,0x02,
                    0x22,0x64,0x00,0x71,0x00,0x11,0x04,0x31,0x31,0x00,
                    0x06,0x28,0x00,0x00,0x0f,0x33,0x37,0x40,0x00,0x00,
                    0x00,0x00,0x00,0x00,0x02,(byte)0xD2,0x01,0x20,0x12,(byte)0x98,
                    ...
                    0x31,0x32,0x33,0x5f,0x2a,0x02,0x00,0x36,(byte)0x82,0x02,
    ...
    public void test0210Unpack() {
        ...
        try {
            final byte[] inputData = { 0x02,0x10,0x30,0x3a,0x00,0x01,0x02,(byte)0xc2,(byte)0x82,0x01,0x09,0x20,0x00,0x00,0x00,0x00,0x02,0x15,(byte)0x98,
                                       0x07,0x48,(byte)0x90,0x10,0x31,0x45,0x09,0x05,0x09,0x05,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x37,0x36,0x57,0x31,
                                       ...
                                       0x5c,0x00,0x36,0x30,0x31,0x30,(byte)0x91,0x08,(byte)0x8f,(byte)0xee,0x5e,0x04,0x00,(byte)0x82,0x00,0x00,0x1e,(byte)0xed,
            ...
            assertEquals( "TOK51636180000337440058\\", msg.get(_047_ADDITIONAL_DATA_NATIONAL));
            assertEquals( "036", msg.get(_049_TRAN_CURRENCY_CODE));
            assertEquals( "91088FEE5E0400820000", msg.get(_055_ICC_DATA));
            //assertEquals( "tms/nm flags", msg.get(_060_ADDITIONAL_PRIVATE));
            assertEquals( "1EED120300000000", msg.get(_064_MAC));
    ...
    public void test0220AdvicePack() {
        try {
            ...
            msg.set(_041_CARD_ACCEPTOR_TERMINAL_ID, "F2773051");
            msg.set(_042_CARD_ACCEPTOR_ID_CODE, "611000602002773");
            msg.set(_047_ADDITIONAL_DATA_NATIONAL, "FBKE\\TCC07\\" );
            msg.set(_049_TRAN_CURRENCY_CODE, "036" );
            msg.set(_055_ICC_DATA, "5f2a02003682020000950500000000009a031610019c01009f02060000000020009f03060000000000009f100706011103a000009f1a0200369f2608ea9308c1bbc97fab9f2701809f33030060409f34031f00009f3501229f360207939f3704065747bd8a025a339f6e04207000008407a00000000310109f660436804000");
            msg.set(_057_CASH_AMOUNT, "000000000000");
            msg.set(_060_ADDITIONAL_PRIVATE, "0");
            msg.set(_064_MAC, "391E4F1D00000000");
            ...
            byte[] expected = {
                    ...
                    0x10,0x01,0x00,0x71,0x00,0x11,0x04,0x31,0x31,0x00,
                    0x06,0x28,0x00,0x00,0x0f,0x33,0x37,0x40,0x00,0x00,
                    0x00,0x00,0x00,0x00,0x02,(byte)0xD2,0x01,0x20,0x12,(byte)0x98,
                    0x31,0x20,(byte)0x93,(byte)0x88,0x12,0x3F,0x30,0x30,0x30,0x30,
                    ...
                    0x5c,0x00,0x36,0x31,0x32,0x37,0x5f,0x2a,0x02,0x00,
    ...
    public void test0230AdviceUnpack() {
        ...
        try {
            final byte[] inputData = {
                    ...
                    0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x20,0x00,0x02,
                    0x41,0x01,0x02,0x07,0x26,0x10,0x01,0x10,0x01,0x31,
                    0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x30,0x30,0x30,
                    0x30,0x30,0x30,0x30,0x30,0x32,0x33,0x37,0x36,0x30,
                    0x30,0x46,0x32,0x37,0x37,0x33,0x30,0x35,0x31,0x36,
                    0x31,0x31,0x30,0x30,0x30,0x36,0x30,0x32,0x30,0x30,
                    0x32,0x37,0x37,0x33,0x30,0x32,0x34,0x54,0x4f,0x4b,
                    0x34,0x33,0x36,0x33,0x38,0x34,0x38,0x38,0x39,0x39,
                    0x39,0x39,0x37,0x34,0x32,0x38,0x35,0x39,0x39,0x39,
                    0x5c,0x00,0x36,0x3f,0x01,0x26,(byte)0x95,0x00,0x00,
                    0x00,0x00 };
            As2805Woolworths msg = new As2805Woolworths(inputData);
            ...
            assertEquals( "F2773051", msg.get(_041_CARD_ACCEPTOR_TERMINAL_ID));
            assertEquals( "611000602002773", msg.get(_042_CARD_ACCEPTOR_ID_CODE));
            assertEquals( "TOK43638488999974285999\\", msg.get(_047_ADDITIONAL_DATA_NATIONAL));
            assertEquals( "036", msg.get(_049_TRAN_CURRENCY_CODE));
            //assertEquals( "91088FEE5E0400820000", msg.get(_055_ICC_DATA));
            //assertEquals( "tms/nm flags", msg.get(_060_ADDITIONAL_PRIVATE));
            assertEquals( "3F01269500000000", msg.get(_064_MAC));
    ...
    public void test0310Unpack() {
        try {
            final byte[] inputData = {
                    ...
                    (byte)0x90,0x02,0x08,0x24,0x10,0x01,0x31,0x31,0x00,0x06,
            ...
            assertEquals( "F2773051", msg.get(_041_CARD_ACCEPTOR_TERMINAL_ID));
            assertEquals( "611000602002773", msg.get(_042_CARD_ACCEPTOR_ID_CODE));
            assertEquals( "".toUpperCase(), msg.get(_048_ADDITIONAL_DATA));
            assertEquals( "0001", msg.get(_071_MESSAGE_NUMBER));
            assertEquals( "606CCA1300000000", msg.get(_128_MAC));
    ...
    public void test0421AdvicePack() {
        try {
            ...
            msg.set(_047_ADDITIONAL_DATA_NATIONAL, "TCC07\\");
            msg.set(_049_TRAN_CURRENCY_CODE, "036" );
            msg.set(_055_ICC_DATA, "5f2a02003682020000950500000000009a031610019c01009f02060000000020009f03060000000000009f100706011103a000009f1a0200369f2608ea9308c1bbc97fab9f2701809f33030060409f34031f00009f3501229f360207939f3704065747bd9f660436804000");
            msg.set(_057_CASH_AMOUNT, "000000000000");
            msg.set(_060_ADDITIONAL_PRIVATE, "0");
            msg.set(_090_ORIGINAL_DATA_ELEMENTS, "020002226402072601100000000000000000000000");
            msg.set(_128_MAC, "712c456200000000");
            ...
            byte[] expected = {
                    ...
                    0x00,0x71,0x00,0x11,0x31,0x31,0x00,0x06,0x28,0x00,
                    0x00,0x0f,0x33,0x37,0x40,0x00,0x00,0x00,0x00,0x00,
                    ...
                    0x36,0x54,0x43,0x43,0x30,0x37,0x5c,0x00,0x36,0x31,
                    0x30,0x37,0x5f,0x2a,0x02,0x00,0x36,(byte)0x82,0x02,0x00,
    ...
    public void test0430AdviceUnpack() {
        ...
        try {
            final byte[] inputData = {
                    ...
                    0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x20,0x00,0x02,
                    0x22,0x65,0x10,0x01,0x31,0x31,0x00,0x06,0x28,0x00,
            ...
            //assertEquals( "91088FEE5E0400820000", msg.get(_055_ICC_DATA));
            //assertEquals( "tms/nm flags", msg.get(_060_ADDITIONAL_PRIVATE));
            assertEquals( "89F959E400000000", msg.get(_064_MAC));
    ...
    public void test0600Pack() {
        try {
            ...
            msg.set(_041_CARD_ACCEPTOR_TERMINAL_ID, "F2773051");
            msg.set(_042_CARD_ACCEPTOR_ID_CODE, "611000602002773");
            msg.set(_064_MAC, "E69A0E1600000000");

            byte[] actual = msg.toMsg();
            byte[] expected = {
                    0x06,0x00,0x20,0x20,0x00,0x01,0x00,(byte)0xc0,0x00,0x01,
                    (byte)0x96,0x00,0x00,0x02,0x41,0x02,0x31,0x31,0x00,0x06,
    ...
    @Test
    public void test0610Unpack() {

        try {
            final byte[] inputData = {
                    0x06,0x10,(byte)0xa0,0x3a,0x00,0x01,0x02,(byte)0xc1,0x00,0x00,
                    0x00,0x7f,(byte)0x87,(byte)0x80,(byte)0x80,0x00,0x06,0x01,(byte)0x96,0x00,
                    0x00,0x02,0x41,0x02,0x02,0x09,0x42,0x10,0x01,0x10,
                    0x01,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x30,
                    0x30,0x46,0x32,0x37,0x37,0x33,0x30,0x35,0x31,0x36,
                    0x31,0x31,0x30,0x30,0x30,0x36,0x30,0x32,0x30,0x30,
            ...
            assertEquals( "39F3638800000000", msg.get(_128_MAC));
    ...
    public void test0610UnpackV2() {
        ...
        try {
            final byte[] inputData = {
                    ...
                    (byte)0x06, (byte)0x01, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x01, (byte)0x88, (byte)0x31, (byte)0x21, (byte)0x53, (byte)0x57, (byte)0x11, (byte)0x02, (byte)0x11, (byte)0x02, (byte)0x31,
                    (byte)0x31, (byte)0x00, (byte)0x06, (byte)0x28, (byte)0x00, (byte)0x00, (byte)0x0F, (byte)0x30, (byte)0x30, (byte)0x57, (byte)0x32, (byte)0x37, (byte)0x37, (byte)0x33, (byte)0x30, (byte)0x34,
                    (byte)0x33, (byte)0x36, (byte)0x31, (byte)0x31, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x36, (byte)0x30, (byte)0x34, (byte)0x30, (byte)0x30, (byte)0x32, (byte)0x37, (byte)0x37, (byte)0x33,
                    (byte)0x30, (byte)0x32, (byte)0x34, (byte)0x54, (byte)0x4F, (byte)0x4B, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x38, (byte)0x39, (byte)0x39, (byte)0x39,
                    (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x39, (byte)0x5C, (byte)0x30, (byte)0x30, (byte)0x30, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x20, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
                    (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0xF7, (byte)0xB1, (byte)0xFC, (byte)0x90,
            ...
            assertEquals( "TOK00000089999999999999\\", msg.get(_047_ADDITIONAL_DATA_NATIONAL));
            ...
            assertEquals( "0000000000", msg.get(_118_CASHOUTS_NUMBER));
            assertEquals( "0000000000000000", msg.get(_119_CASHOUTS_AMOUNT));
            assertEquals( "F7B1FC9000000000", msg.get(_128_MAC));
    ...
    public void test0800Pack() {
        try {
            ...
            byte[] expected = {0x08,0x00,(byte)0x80,0x20,0x00,0x01,0x00,(byte)0xc1,0x00,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x48,
                              (byte)0x92,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x57,0x31,0x38,0x36,0x34,0x30,0x30,0x35,0x36,0x31,0x31,0x30,0x30,
    ...
    public void test0810Unpack() {
        ...
        try {
            final byte[] inputData = {0x08,0x10,(byte)0x80,0x38,0x00,0x01,0x02,(byte)0xe1,(byte)0x88,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,
                    0x48,(byte)0x92,0x10,0x31,0x52,0x09,0x05,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x30,0x30,0x57,0x31,0x38,0x36,0x34,0x30,0x30,0x35,
            ...
            assertEquals( "3FFC73B60DFB7A53CD5C73AFE33CCEC1DF3B8F080450B7BE6040F0CB85F67B72064E5251D4A1F6FDD13C240C1D110B2400BAB855404502C03E0C0CDDD417A0B1CF936001D130C6507A88072B22FE34D1A407AD09B8595A1389054675ADFAAA3F4653B4600BA68DC2C29BF664CA1C2DB2B33872", msg.get(_048_ADDITIONAL_DATA)); // This now will return the string value
            assertEquals( "036", msg.get(_049_TRAN_CURRENCY_CODE));
            assertEquals( "0000000000000001", msg.get(_053_SECURITY_RELATED_CONTROL_INFORMATION));
            assertEquals( "101", msg.get(_070_NMIC));
    ...
    public void test0800RSA191Pack() {
        try {
            ...
            msg.set(_048_ADDITIONAL_DATA, "");
            //msg.set(_060_ADDITIONAL_PRIVATE, "s/w vers 1234");
            ...
            byte[] expected = {
                    ...
                    0x00,0x31,0x31,0x00,0x06,0x28,0x00,0x00,0x0f,0x4e,
    ...
    public void test0810RSA191Unpack() {
        ...
        try {
            final byte[] inputData = {
                    ...
                    0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                    0x00,0x01,0x59,0x22,0x09,0x16,0x31,0x31,0x00,0x06,
            ...
            assertEquals( "".toUpperCase(), msg.get(_048_ADDITIONAL_DATA)); // This now will return the string value
            assertEquals( "000", msg.get(_049_TRAN_CURRENCY_CODE));
            assertEquals( "191", msg.get(_070_NMIC));
    ...
    public void test0800RSA192Pack() {
        try {
            ...
            msg.set(_041_CARD_ACCEPTOR_TERMINAL_ID, "N9393001");
            msg.set(_042_CARD_ACCEPTOR_ID_CODE, "057998206712988");
            msg.set(_048_ADDITIONAL_DATA, "");
            msg.set(_070_NMIC, "192");
    ...
    public void test0810RSA192Unpack() {
        ...
        try {
            final byte[] inputData = {
                    0x08,0x10,(byte)0x80,0x38,0x00,0x01,0x02,(byte)0xc1,(byte)0x80,0x00,
                    0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                    0x00,0x01,0x59,0x24,0x09,0x16,0x31,0x31,0x00,0x06,
                    0x28,0x00,0x00,0x0f,0x30,0x30,0x4e,0x39,0x33,0x39,
                    0x33,0x30,0x30,0x31,0x30,0x35,0x37,0x39,0x39,0x38,
            ...
            assertEquals( "000", msg.get(_049_TRAN_CURRENCY_CODE));
            assertEquals( "192", msg.get(_070_NMIC));
    ...
    public void test0810RSA193Unpack() {
        ...
        try {
            final byte[] inputData = {
                    0x08,0x10,(byte)0x80,0x38,0x00,0x01,0x02,(byte)0xc1,(byte)0x80,0x00,
                    0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                    0x00,0x01,0x59,0x25,0x09,0x16,0x31,0x31,0x00,0x06,
                    0x28,0x00,0x00,0x0f,0x30,0x30,0x4e,0x39,0x33,0x39,
                    0x33,0x30,0x30,0x31,0x30,0x35,0x37,0x39,0x39,0x38,
                    0x32,0x30,0x36,0x37,0x31,0x32,0x39,0x38,0x38,0x30,
            ...
            assertEquals( "000", msg.get(_049_TRAN_CURRENCY_CODE));
            assertEquals( "193", msg.get(_070_NMIC));
